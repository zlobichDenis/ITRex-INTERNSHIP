...
const createSignInMarkup = (isValidPass, isValidEmail, emailValue = '', passwordValue = '') => {
    return (
        `<div class="feedback-wrapper feedback-wrapper_sign-in">
            <form class="feedback-form">
                ...
                <div class="feedback-field">
                    ...
                    <input value="${passwordValue}" id="feedback-field__input_pass" class="feedback-field__input" type="password" placeholder="Password" name="pass">
...
export default class SignIn extends AbstractComponent {
    ...
    _inputsValidation(element) {
        element.querySelector('#feedback-field__input_email').addEventListener('blur', (evt) => {
            this.email = evt.target.value;
            this._isValidEmail = validator.isEmail(evt.target.value) || validator.isEmpty(evt.target.value);
            this.rerender();
        })

        element.querySelector('#feedback-field__input_pass').addEventListener('blur', (evt) => {
