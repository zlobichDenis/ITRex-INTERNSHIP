...
const SignInForm = () => {
    ...
    return (
        ...
        <div className="feedback-field">
            ...
            <input className="feedback-field__input feedback-field__input_password" id="feedback-field__input_pass" type={isShowingPass ? 'text' : 'password'} placeholder="Password" name="pass" />
