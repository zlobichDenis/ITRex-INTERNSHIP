...
const PatientViewHeader = () => {
    return (
        ...
        <div className="patient-cabinet__patient">
            <p>
                <span className="patient-cabinet__patient-name">Larry Prinston</span>
                <span className="patient-cabinet__patient-specialty">Patient</span>
            </p>
            <img src="img/person-photo-2.png" alt="Patient's photo" />
        </div>
    </div>
    )
};
